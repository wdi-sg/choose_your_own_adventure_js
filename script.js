...
const game = {
  ...
  two: {
    ...
    yes: {
      ...
      no: {
        text: `The little bear hangs its head and tumbles away sadly. What will you do? (follow/bye/back)\n\n`,
        follow: {
    ...
    no: {
      ...
      sleep: {
        ...
        \n\n`,
        hilltop: {
          text: `You reach the hilltop and doze off together. yourname starts to roll down the hill. Luckily, the little bear jumps to the rescue and the two of them have the best nap ever, becoming best friends forever. \n ʕ◡ ᴥ ◡ʔ\n\n`
        },
        meadow: {
          text: `yourname and the little bear find a peaceful spot in the meadow and doze off. A lion stealthily approaches, but the little bear is alert, and manages to fight it off. The two of them have the best nap ever, becoming best friends forever.
          \n ʕ◡ ᴥ ◡ʔ\n\n`
        }
      }
    }
