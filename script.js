    ...
    attack: {
        ...
        moves: {
            moonsault: {
                ...
                results: "you're a total noob and COMPLETELY butchered the move! you ended up knocking yourself out cold and got stretchered out of the ring. how embarassing!"
            },
            chokeslam: {
                ...
                nextMoves: {
                    submission: {
                        ...
                        results: "CRITICAL HIT! bretman the hitman hart is rendered completely useless and taps out. you won!",
                    },
                    moonsault: {
            ...
            dropkick: {
                ...
                nextMoves: {
                    turnbuckles: {
                        ...
                        results: "CRITICAL HIT! you performed a perfect moonsault and bretman the hitman hart taps out! you win! ",
                    },
                    ringropes: {
                        name: "immediately throw your body against the ring ropes",
                        results: "yikes! bretman the hitman hart was faking it all along and trips you up on your re-entry, he performs YOUR move with perfection and forces you into submission with his finishing move, <strong>the sharpshooter</strong>! you struggle in his arms and tap out. didn't see that coming!",
                    }
                },
            }
        },
            ...
            tagteam: {
                ...
                nextMoves: {
                    grabankles: {
                        ...
                        results: "ASSIST +1! (too bad this is not the NBA) you managed to gain an assist and trip over bretman the hitman hart where stone cold steve austin performed the stone cold stunner and forced him into submission! ",
                    },
                    flee: {
                        name: "immediately flee",
                        results: "the crowd started BOO-ing you as you flee-ed out of the ring in shame. how embarassing!",
                    }
                },
            }
        },
    ...
    run: {
        ...
        moves: {
            running: {
                ...
                results: "interesting choice, seems like you've not learned your lesson. you collapse in exhaustion and mike chioda had no choice but to stretcher you out of the ring. how embarassing!"
            },
            attack: {
...
var restartGame = function(gameover) {
    if (gameOver === true) {
        steps = 0;
        return steps;
    }
