    ...
    return output;
        ...
        if (userName.length === 1 && classArray.length === 0 && (currentInput === "Warrior" || currentInput === "Magician")){
            ...
            if (userName.length === 1 && classArray[0] === "Warrior" && currentInput === "Light"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Sword, \r Mace.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Warrior" && currentInput === "Flame"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Flame, \r Oil.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Warrior" && currentInput === "Earth"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Shield, \r Plate Armor.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Warrior" && currentInput === "Death"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Tombstone, \r Shovel.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Magician" && currentInput === "Light"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Staff, \r Holy Water.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Magician" && currentInput === "Flame"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Spell Book, \r Cloak.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Magician" && currentInput === "Earth"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Tree Branch, \r Animal Skull.";
                return output;
                }
            if (userName.length === 1 && classArray[0] === "Magician" && currentInput === "Death"){
                ...
                document.getElementById('input').value = "";
                document.getElementById('input').placeholder = "Please choose your Token.";
                var output = "You haven Not Selected the correct response. Please enter only the below: \r Casket, \r Bandage.";
                return output;
                }
        else if (userName.length === 1 && classArray.length === 1){
            document.getElementById('input').value = "";
            document.getElementById('input').placeholder = "Please choose your Element.";
            var output = "You haven Not Selected the correct response. Please enter only the below: \r Light, \r Flame, \r Earth, \r Death.";
            return output;
        }
