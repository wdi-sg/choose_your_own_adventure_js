...
if (challenge=="n") {
    alert("You decided against the fight. It seemed like the prudent choice.");
        ...
        while (run==1) {
            ...
            var reaction = prompt("Your opponent steps into the middle of the classroom. You do the same. Adrenaline pumps through your veins as you move in. Do you:\n (P)unch - high accuracy, low damage \n (K)ick - medium accuracy, medium damage \n (B)odyslam - low accuracy, high damage").toLowerCase();
            ...
            // alert(userOutcome + "and " + opponentOutcome);
            run -= 1;
    }
}
