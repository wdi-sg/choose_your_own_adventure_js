...
var createTooltip = function(){
    ...
    if(id === "HP"){
        tooltip.innerHTML = "The player's health determines whether the player is alive.<br>The game will be over once it reaches 0.";
    } else if (id === "Battery"){
        tooltip.innerHTML = "The battery determines background brightness.<br>At 0, it is impossible to read the map."
    } else if (id === "Radiation"){
        tooltip.innerHTML = "The radiation determines the volume of the Geiger Counter.<br>Each movement will increase the radiation by 1.<br>The game will be over once it reaches 30."
    } else if (id === "Oxygen"){
        tooltip.innerHTML = "The oxygen determines whether the player is alive.<br>Each movement underwater will decrease the tank by 1.<br>Oxygen does not refill on land due to the radiation in the air.<br>The game will be over once it reaches 0."
    } else if (id === "Bullet"){
        tooltip.innerHTML = "The bullets determines the number of time a player can use the gun.<br>The bullets deals more damage than the shiv<br>The gun will no longer be an option when it reaches 0."
    } else if (id === "input"){
        tooltip.innerHTML = "This is the input textbox.<br>To make a decision, simply type in your choice according to the log below."
    } else if (id === "output"){
        tooltip.innerHTML = "This is the game log.<br>The story will be narrated here.<br>Read carefully to understand the context, and your objectives."
    } else if (id === "map"){
        tooltip.innerHTML = "This is the map.<br>The map becomes unreadable in the dark.<br>The entrance is marked with the ^ symbol."
    }
    document.querySelector(".stats").appendChild(tooltip);
}

var rmvTooltip = function(){
    console.log("Bye")
    var tooltip = document.querySelector(".tooltip")
    tooltip.remove();
}

document.querySelector("#HP").addEventListener("mouseover", createTooltip);
document.querySelector("#HP").addEventListener("mouseout", rmvTooltip);
document.querySelector("#Battery").addEventListener("mouseover", createTooltip);
document.querySelector("#Battery").addEventListener("mouseout", rmvTooltip);
document.querySelector("#Radiation").addEventListener("mouseover", createTooltip);
document.querySelector("#Radiation").addEventListener("mouseout", rmvTooltip);
document.querySelector("#Oxygen").addEventListener("mouseover", createTooltip);
document.querySelector("#Oxygen").addEventListener("mouseout", rmvTooltip);
document.querySelector("#Bullet").addEventListener("mouseover", createTooltip);
document.querySelector("#Bullet").addEventListener("mouseout", rmvTooltip);
document.querySelector("#input").addEventListener("mouseover", createTooltip);
document.querySelector("#input").addEventListener("mouseout", rmvTooltip);
document.querySelector("#output").addEventListener("mouseover", createTooltip);
document.querySelector("#output").addEventListener("mouseout", rmvTooltip);
document.querySelector("#map").addEventListener("mouseover", createTooltip);
document.querySelector("#map").addEventListener("mouseout", rmvTooltip);
