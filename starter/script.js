// put code here!
//creat a function for user name inputs
// var myname = function(){
...
if (cellbreakkidnapper === ("F" && "f")){
    ...
    var runaway = prompt("The kidnapper saw you running away, he took out the gun and shoot you. You are died. Press A to restart or Press Q to quit.");
        }
